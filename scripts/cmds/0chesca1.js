  ...
  onStart: async function ({ api, event, args, usersData }) {
    try {
      ...
      if (query) {
        ...
        const apiUrl = `https://liaspark.chatbotcommunity.ltd/@LianeAPI_Reworks/api/chesca1?key=j86bwkwo-8hako-12C&userName=${encodeURIComponent(name || "a user")}&query=${encodeURIComponent(query)}`;
