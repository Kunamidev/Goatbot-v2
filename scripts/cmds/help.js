...
const doNotDelete = "[ 🤖 | HERUBOT ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
...
module.exports = {
	...
	onStart: async function ({ message, args, event, threadsData, role }) {
		...
		if (args.length === 0) {
			...
			msg += `🐐 | 𝐆𝐎𝐀𝐓𝐁𝐎𝐓 𝐕2`; // its not decoy so change it if you want 
